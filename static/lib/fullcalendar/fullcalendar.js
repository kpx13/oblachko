...
function View(element, calendar, viewName) {
	...
	*/
	...
	function eventDrop(e, event, dayDelta, minuteDelta, allDay, ev, ui) {
        ...
        $.post("/calendar/ajax_change/", { 
                'id': event.db_id,
                's_d': event.start.getDate(),
                's_m': event.start.getMonth(),
                's_y': event.start.getFullYear(),
                's_h': event.start.getHours(),
                's_min': event.start.getMinutes(),
                'e_d': event.end.getDate(),
                'e_m': event.end.getMonth(),
                'e_y': event.end.getFullYear(),
                'e_h': event.end.getHours(),
                'e_min': event.end.getMinutes(),
